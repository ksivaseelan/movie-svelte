...
<a sveltekit:prefetch href="/details/{movie.id}">
    <div class="group m-6 relative h-500 w-600">
        <object
            title="placeholder-for-error"
            data="/images/film-reel.png"
            type="image/png"
        >
            <img
        ...
        <div class=" p-6 absolute inset-x-0 bottom-0 text-white">
            ...
            <br />
            <p class="group-hover:block hidden font-semibold text-gray-light">
